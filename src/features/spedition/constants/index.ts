...
export const EXPENSE_CATEGORIES: {
  ...
  {
    value: 'TOLL_DOMESTIC',
    labelKey: 'spedition:expenses.categories.TOLL_DOMESTIC',
    icon: Receipt,
  },
  {
    value: 'TOLL_INTERNATIONAL',
    labelKey: 'spedition:expenses.categories.TOLL_INTERNATIONAL',
    icon: Receipt,
  },
  {
    value: 'PER_DIEM',
    labelKey: 'spedition:expenses.categories.PER_DIEM',
    icon: Utensils,
  },
  {
    value: 'PARKING',
    labelKey: 'spedition:expenses.categories.PARKING',
    icon: ParkingSquare,
  },
  {
    value: 'VIGNETTE',
    labelKey: 'spedition:expenses.categories.VIGNETTE',
    icon: ShieldCheck,
  },
  {
    value: 'CUSTOMS',
    labelKey: 'spedition:expenses.categories.CUSTOMS',
    icon: Landmark,
  },
  {
    value: 'BORDER_FEE',
    labelKey: 'spedition:expenses.categories.BORDER_FEE',
    icon: MapPin,
  },
  {
    value: 'FERRY',
    labelKey: 'spedition:expenses.categories.FERRY',
    icon: Ship,
  },
  {
    value: 'MAINTENANCE',
    labelKey: 'spedition:expenses.categories.MAINTENANCE',
    icon: Wrench,
  },
  {
    value: 'WASH',
    labelKey: 'spedition:expenses.categories.WASH',
    icon: Droplets,
  },
  {
    value: 'PHONE',
    labelKey: 'spedition:expenses.categories.PHONE',
    icon: Phone,
  },
  {
    value: 'FINE',
    labelKey: 'spedition:expenses.categories.FINE',
    icon: AlertTriangle,
  },
  {
    value: 'OTHER',
    labelKey: 'spedition:expenses.categories.OTHER',
    icon: MoreHorizontal,
  },
]
...
export const STOP_TYPE_COLORS: Record<StopType, string> = {
  ...
  CUSTOMS: 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300',
